...
import type { ILoginForm } from "../../login";
import type { IRegistrationForm } from "../../registration";

interface IProps {
    errors: FieldErrors<ILoginForm> | FieldErrors<IRegistrationForm>
    isSigned: boolean
}

const Sign:FC<IProps> = ({errors, isSigned}) => {
